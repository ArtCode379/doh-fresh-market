package dohdohs.grocery.dohfreshmarket.ui.composable.approot
...
import dohdohs.grocery.dohfreshmarket.ui.composable.navigation.AppNavHost
import dohdohs.grocery.dohfreshmarket.ui.composable.navigation.NavRoute
...
private val navigationItems: List<BottomNavItem> = listOf(
    BottomNavItem(
        titleRes = R.string.huffn_bottom_bar_nav_item_home_title,
        icon = Icons.Default.Home,
        route = NavRoute.Home,
    ),
    BottomNavItem(
        titleRes = R.string.huffn_bottom_bar_nav_item_cart_title,
        icon = Icons.Default.ShoppingCart,
        route = NavRoute.Cart,
    ),
    BottomNavItem(
        titleRes = R.string.huffn_bottom_bar_nav_item_orders_title,
        icon = Icons.Default.CalendarToday,
        route = NavRoute.Orders,
    ),
    BottomNavItem(
        titleRes = R.string.huffn_bottom_bar_nav_item_settings_title,
