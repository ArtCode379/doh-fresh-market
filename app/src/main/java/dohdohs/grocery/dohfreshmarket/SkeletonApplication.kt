...
import dohdohs.grocery.dohfreshmarket.di.dataModule
import dohdohs.grocery.dohfreshmarket.di.dispatcherModule
import dohdohs.grocery.dohfreshmarket.di.viewModule
...
class HUFFNApplication : Application() {
    //[FIREBASE][appScope]
    ...
    override fun onCreate() {
        ...
        startKoin {
            androidLogger()
            androidContext(this@HUFFNApplication)
            modules(appModules)
        }
