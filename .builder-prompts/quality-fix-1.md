Fix the Android project at /tmp/doh-fresh-market so the failing quality-fix-1 step passes.
...
Recent failure log:
```text
=== QUALITY CHECK: /tmp/doh-fresh-market ===
...
0 entries
  ...
  OK: icon.png (201227B, 512x512, rounded opaque canvas, transparent corners)
FAIL: Manifest references .SkeletonApplication but class not found — CRASH
  OK: HomeScreen.kt: 150 lines
